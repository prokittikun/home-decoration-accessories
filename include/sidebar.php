...
<div class="list-group mt-5">
    ...
    if (isset($_SESSION['user_id'])) { ?>
        <a style="border-radius: 20px;" class="list-group-item list-group-item-danger mt-2 mb-2 " onclick="logout();">ออกจากระบบ</a>
    <?php
    } else { ?>
        <a href="login.php" style="border-radius: 20px;" class="list-group-item list-group-item-primary mt-2 mb-2 ">เข้าสู่ระบบ</a>
    <?php
    }
    ?>
</div>
